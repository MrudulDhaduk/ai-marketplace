...
const { authenticateUser, requireSelfParam } = require("../middleware/auth");
...
router.post("/api/projects", authenticateUser, async (req, res) => {
  try {
...
router.get("/profile/:id", authenticateUser, requireSelfParam("id"), async (req, res) => {
  try {
    const { id } = req.params;
    // 🔍 get user
...
router.get("/profile/:id/skills", authenticateUser, async (req, res) => {
  try {
    const { id } = req.params;
...
router.post("/profile/:id/skills", authenticateUser, async (req, res) => {
  try {
    const { id } = req.params;
...
router.delete("/profile/:id/skills", authenticateUser, async (req, res) => {
  try {
    const { id } = req.params;
    const { skill } = req.body;
...
router.get("/projects/discover/:id", authenticateUser, requireSelfParam("id"), async (req, res) => {
  try {
    const { id } = req.params;
...
════════════════════════════════════════════════════ */
router.post("/projects/:id/bid", authenticateUser, async (req, res) => {
  try {
    const { id } = req.params;
...
════════════════════════════════════════════════════ */
router.get("/api/projects/:projectId/bids", authenticateUser, async (req, res) => {
...
router.get("/projects/assigned/:id", authenticateUser, async (req, res) => {
  try {
    const { id } = req.params;
...
router.get("/bids/developer/:id", authenticateUser, requireSelfParam("id"), async (req, res) => {
  try {
    const { id } = req.params;
...
router.put("/projects/:id/complete", authenticateUser, async (req, res) => {
  try {
    const { id } = req.params;
...
════════════════════════════════════════════════════ */
router.post("/projects/:id/submit", authenticateUser, async (req, res) => {
  try {
    const { id } = req.params;
...
router.get("/projects/:id/submissions", authenticateUser, async (req, res) => {
  try {
    const { id } = req.params;
...
router.get("/api/projects/:id", authenticateUser, async (req, res) => {
  try {
...
router.put("/projects/:id/review", authenticateUser, async (req, res) => {
  try {
    const { id } = req.params;
...
router.post("/projects/:id/upload", authenticateUser, uploadLimiter, (req, res) => {
  upload.fields([
...
router.get("/projects/:id/files", authenticateUser, async (req, res) => {
  try {
    const { id } = req.params;
...
router.put("/files/reorder", authenticateUser, async (req, res) => {
  try {
